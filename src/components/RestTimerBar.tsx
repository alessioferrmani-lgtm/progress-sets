      ...
      <div className="ios-blur mx-auto max-w-md overflow-hidden rounded-2xl shadow-lg">
        ...
        <div className="flex items-center gap-3 px-3 py-2.5">
          <div className="flex-1">
            <div className="max-w-[130px] truncate text-[11px] font-medium uppercase tracking-wide text-label-tertiary">
              {exerciseName ?? "Recupero"}
            </div>
          ...
          {notificationPermission === "default" && (
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-fill text-accent active:scale-[0.97]"
              aria-label="Attiva notifica di fine recupero"
            >
