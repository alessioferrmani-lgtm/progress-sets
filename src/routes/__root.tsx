...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "icon",
        href: "/progress-sets-favicon-16-v2.png",
        type: "image/png",
        sizes: "16x16",
      },
      {
        rel: "icon",
        href: "/progress-sets-favicon-32-v2.png",
        type: "image/png",
        sizes: "32x32",
      },
      { rel: "shortcut icon", href: "/progress-sets-favicon-v2.ico" },
      {
        rel: "apple-touch-icon",
        href: "/progress-sets-apple-touch-icon-v2.png",
        sizes: "180x180",
      },
